...
class QuestionRepositoryTest {
    ...
    void findMainList() {
        ...
        List<Object[]> given = Arrays.asList(
                new Object[]   {"질문글 제목 01",	"질문내용 01",	"tag 01",	time, 2}
                , new Object[] {"질문글 제목 03",	"질문내용 03",	"tag 03",	time, 1}
                , new Object[] {"질문글 제목 04",	"질문내용 04",	"tag 04",	time, 1}
                , new Object[] {"질문글 제목 05",	"질문내용 05",	"tag 05",	time, 1}
                , new Object[] {"질문글 제목 06",	"질문내용 06",	"tag 06",	time1, 1}
                , new Object[] {"질문글 제목 07",	"질문내용 07",	"tag 07",	time1, 1}
                , new Object[] {"질문글 제목 08",	"질문내용 08",	"tag 08",	time1, 1}
                , new Object[] {"질문글 제목 09",	"질문내용 09",	"tag 09",	time1, 1}
        );
